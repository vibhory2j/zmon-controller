		...
		.and()
			.authorizeRequests()
				.antMatchers(HttpMethod.GET, "/api/v1/**")
					.access("(hasAuthority('USER') && #oauth2.hasScope('uid') && #oauth2.hasAnyRealm('/employees')) or (#oauth2.hasScope('uid') && #oauth2.hasAnyRealm('/services')) or #oauth2.hasScope('zmon.read_all')")
				.antMatchers(HttpMethod.POST, "/api/v1/**")
					.access("(hasAuthority('USER') && #oauth2.hasScope('uid') && #oauth2.hasAnyRealm('/employees')) or (#oauth2.hasScope('uid') && #oauth2.hasAnyRealm('/services')) or #oauth2.hasScope('zmon.write_all')")
